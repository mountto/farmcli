...
powershell "Get-PnpDevice -PresentOnly -Class USB | Where-Object { $_.InstanceId -match '^USB\\VID_04E8&PID_6860' } | Select-Object @{n='InstanceID';e={$_.InstanceId -replace '^PCI\\(.*?)&REV.*$','$1'}}" > InstanceId.txt
echo "FIN"
pause